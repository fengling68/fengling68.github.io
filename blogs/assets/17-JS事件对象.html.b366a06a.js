import{_ as e,o as n,c as t,f as o}from"./app.aafb335d.js";const c={},a=o(`<h1 id="js事件对象" tabindex="-1"><a class="header-anchor" href="#js事件对象" aria-hidden="true">#</a> JS事件对象</h1><h2 id="事件对象" tabindex="-1"><a class="header-anchor" href="#事件对象" aria-hidden="true">#</a> 事件对象</h2><pre><code>信息库：该事件的所有信息属性和方法，如鼠标位置或键盘键码
每个事件都有一个事件对象。
