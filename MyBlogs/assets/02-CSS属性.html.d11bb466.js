import{_ as r,o as d,c as o,f as n}from"./app.a39d0481.js";const a={};function t(i,e){return d(),o("div",null,[...e[0]||(e[0]=[n(`<h1 id="css属性" tabindex="-1"><a class="header-anchor" href="#css属性" aria-hidden="true">#</a> CSS属性</h1><h2 id="颜色" tabindex="-1"><a class="header-anchor" href="#颜色" aria-hidden="true">#</a> 颜色</h2><pre><code>rgb颜色(red,green,blue)  rgb(0,0,0)黑色    rgb(255,255,255)白色
...
</code></pre><blockquote><p>注意：outline：none；可以去掉input默认边框</p></blockquote>`,24)])])}const c=r(a,[["render",t],["__file","02-CSS属性.html.vue"]]);export{c as default};
