import{_ as n,o as s,c as a,d as t}from"./app.8d44daf6.js";const p={},o=t(`<h1 id="svg\u5B9E\u73B0\u6247\u5F62\u8499\u5C42" tabindex="-1"><a class="header-anchor" href="#svg\u5B9E\u73B0\u6247\u5F62\u8499\u5C42" aria-hidden="true">#</a> svg\u5B9E\u73B0\u6247\u5F62\u8499\u5C42</h1><div class="language-vue ext-vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div>`,2),e=[o];function c(u,l){return s(),a("div",null,e)}const r=n(p,[["render",c],["__file","svg-fan-shape.html.vue"]]);export{r as default};
