import{_ as t,o as e,c as a,f as s}from"./app.a39d0481.js";const c={};function r(o,n){return e(),a("div",null,[...n[0]||(n[0]=[s(`<h1 id="jsonp跨域请求" tabindex="-1"><a class="header-anchor" href="#jsonp跨域请求" aria-hidden="true">#</a> JSONP跨域请求</h1><h2 id="同源策略-同域策略" tabindex="-1"><a class="header-anchor" href="#同源策略-同域策略" aria-hidden="true">#</a> 同源策略(同域策略)</h2><pre><code>同源/同域：指URL地址的协议、IP地址、端口号相同。
...
</code></pre>`,7)])])}const p=t(c,[["render",r],["__file","27-JSONP跨域请求.html.vue"]]);export{p as default};
