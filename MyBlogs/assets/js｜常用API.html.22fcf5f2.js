import{_ as s,o as a,c as t,f as p}from"./app.c2c029cd.js";const o={};function c(e,n){return a(),t("div",null,[...n[0]||(n[0]=[p(`<h1 id="js-常用-api" tabindex="-1"><a class="header-anchor" href="#js-常用-api" aria-hidden="true">#</a> JS 常用 API</h1><h2 id="_1-节点" tabindex="-1"><a class="header-anchor" href="#_1-节点" aria-hidden="true">#</a> 1. 节点</h2><h3 id="_1-1-节点属性" tabindex="-1"><a class="header-anchor" href="#_1-1-节点属性" aria-hidden="true">#</a> 1.1 节点属性</h3><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>Node<span class="token punctuation">.</span>nodeName<span class="token punctuation">;</span> <span class="token comment">// 返回节点名称，只读</span>
...
</code></pre></div>`,33)])])}const l=s(o,[["render",c],["__file","js｜常用API.html.vue"]]);export{l as default};
