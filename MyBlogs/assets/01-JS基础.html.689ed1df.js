import{_ as n,o as a,c as r,f as t}from"./app.c2c029cd.js";const i={};function d(s,e){return a(),r("div",null,[...e[0]||(e[0]=[t(`<h1 id="js基础" tabindex="-1"><a class="header-anchor" href="#js基础" aria-hidden="true">#</a> JS基础</h1><h2 id="_0、sass和scss区别" tabindex="-1"><a class="header-anchor" href="#_0、sass和scss区别" aria-hidden="true">#</a> 0、sass和scss区别</h2><pre><code>sass不允许出现 {} ， scss可以像css一样使用 {}
...
:compact     每条CSS规则占一行
:compressed  压缩
</code></pre>`,58)])])}const c=n(i,[["render",d],["__file","01-JS基础.html.vue"]]);export{c as default};
