import{_ as e,r as c,o as l,c as u,f as o,a as n,b as a,d as p}from"./app.c2c029cd.js";const i={},k={href:"https://developer.mozilla.org/zh-CN/docs/Web/CSS/object-fit",target:"_blank",rel:"noopener noreferrer"},r={href:"https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/una/CSSgram/blob/master/README-CN.md",target:"_blank",rel:"noopener noreferrer"},g={href:"https://developer.mozilla.org/zh-CN/docs/Web/CSS/mask",target:"_blank",rel:"noopener noreferrer"};function h(m,s){const t=c("ExternalLinkIcon");return l(),u("div",null,[s[15]||(s[15]=o(`<h1 id="常用代码" tabindex="-1"><a class="header-anchor" href="#常用代码" aria-hidden="true">#</a> 常用代码</h1><h2 id="img-无-src-时隐藏" tabindex="-1"><a class="header-anchor" href="#img-无-src-时隐藏" aria-hidden="true">#</a> img 无 src 时隐藏</h2><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">img[src=&quot;&quot;],
...
<span class="token punctuation">}</span>
</code></pre></div><p><img src="https://fengling68.github.io/imgbed/images/1578920981-532x226.webp" alt="文字遮罩预览"></p><h2 id="input-输入光标颜色" tabindex="-1"><a class="header-anchor" href="#input-输入光标颜色" aria-hidden="true">#</a> input 输入光标颜色</h2><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">input</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,8))])}const y=e(i,[["render",h],["__file","20201001｜常用代码.html.vue"]]);export{y as default};
