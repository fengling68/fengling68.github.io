import{_ as o,r as e,o as c,c as l,a as s,b as a,f as t,d as r}from"./app.c2c029cd.js";const u={},i={href:"https://www.npmjs.com/",target:"_blank",rel:"noopener noreferrer"};function k(d,n){const p=e("ExternalLinkIcon");return c(),l("div",null,[n[4]||(n[4]=s("h1",{id:"npm-发布工具包",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#npm-发布工具包","aria-hidden":"true"},"#"),a(" npm 发布工具包")],-1)),n[5]||(n[5]=s("h2",{id:"简单步骤介绍",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#简单步骤介绍","aria-hidden":"true"},"#"),a(" 简单步骤介绍")],-1)),s("ol",null,[n[3]||(n[3]=t("<li><p>按照目录结构创建相应文件；</p></li><li><p>添加 <code>src</code> 代码逻辑；</p></li><li><p>简单配置 <code>rollup.config.js</code> 的编译入口和出口；</p></li><li><p>配置 <code>package.json</code> &amp; <code>.gitignore</code> 文件</p></li><li><p><code>npm i</code> &amp; <code>npm run build</code> 安装依赖和打包</p></li>",5)),s("li",null,[s("p",null,[n[1]||(n[1]=a("发布到",-1)),s("a",i,[n[0]||(n[0]=a("npm",-1)),r(p)]),n[2]||(n[2]=a("上（要先注册账号哦～）",-1))])])]),n[6]||(n[6]=t(`<p>PS：实际项目中可采用 <code>npm init</code> 、<code>vue-cli</code> 等创建编译打包项目后发布，本文主要是为了学习如何发布 npm 包而写的简单示例。</p><h2 id="先上目录结构" tabindex="-1"><a class="header-anchor" href="#先上目录结构" aria-hidden="true">#</a> 先上目录结构</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">.</span>
├── .gitignore
├── package.json
├── rollup.config.js
└── src
...
</code></pre></div>`,13))])}const m=o(u,[["render",k],["__file","npm 发布工具包.html.vue"]]);export{m as default};
