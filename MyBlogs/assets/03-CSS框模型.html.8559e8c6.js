import{_ as a,o as n,c as d,f as r}from"./app.c2c029cd.js";const p={};function i(o,e){return n(),d("div",null,[...e[0]||(e[0]=[r(`<h1 id="css框模型" tabindex="-1"><a class="header-anchor" href="#css框模型" aria-hidden="true">#</a> CSS框模型</h1><h2 id="盒子模型-方框模型、盒子属性" tabindex="-1"><a class="header-anchor" href="#盒子模型-方框模型、盒子属性" aria-hidden="true">#</a> 盒子模型(方框模型、盒子属性)</h2><pre><code>主要设置元素的：
...
padding:20px 0;
margin:20px 0;
</code></pre>`,25)])])}const t=a(p,[["render",i],["__file","03-CSS框模型.html.vue"]]);export{t as default};
