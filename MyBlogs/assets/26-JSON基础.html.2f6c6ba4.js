import{_ as o,o as e,c as t,f as a}from"./app.c2c029cd.js";const s={};function r(u,n){return e(),t("div",null,[...n[0]||(n[0]=[a(`<h1 id="json基础" tabindex="-1"><a class="header-anchor" href="#json基础" aria-hidden="true">#</a> JSON基础</h1><h2 id="json-javascript-object-notation" tabindex="-1"><a class="header-anchor" href="#json-javascript-object-notation" aria-hidden="true">#</a> JSON(JavaScript Object Notation)</h2><pre><code>是一种轻量级的数据交换格式，广泛的用于互联网数据的传输。
...
3、stringify()序列化方法————将json数据转换为json字符串
    ...
    console.log(jsonStr);
</code></pre><p><strong>早期浏览器不支持JSON，使用第三方插件：json2.js</strong></p>`,10)])])}const j=o(s,[["render",r],["__file","26-JSON基础.html.vue"]]);export{j as default};
