import{_ as n,o as s,c as a,f as t}from"./app.4112d7f2.js";const p={},o=t(`<h1 id="数字递增递减动画" tabindex="-1"><a class="header-anchor" href="#数字递增递减动画" aria-hidden="true">#</a> 数字递增递减动画</h1><h2 id="数字直接变化" tabindex="-1"><a class="header-anchor" href="#数字直接变化" aria-hidden="true">#</a> 数字直接变化</h2><ul><li>借助 VueNumberScroll 组件</li></ul><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
