import{_ as s,o as a,c as t,f as p}from"./app.a39d0481.js";const o={};function e(c,n){return a(),t("div",null,[...n[0]||(n[0]=[p(`<h1 id="数字递增递减动画" tabindex="-1"><a class="header-anchor" href="#数字递增递减动画" aria-hidden="true">#</a> 数字递增递减动画</h1><h2 id="数字直接变化" tabindex="-1"><a class="header-anchor" href="#数字直接变化" aria-hidden="true">#</a> 数字直接变化</h2><ul><li>借助 VueNumberScroll 组件</li></ul><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div><h2 id="数字像记分牌一样翻转" tabindex="-1"><a class="header-anchor" href="#数字像记分牌一样翻转" aria-hidden="true">#</a> 数字像记分牌一样翻转</h2><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div>`,6)])])}const l=s(o,[["render",e],["__file","数字递增递减动画.html.vue"]]);export{l as default};
