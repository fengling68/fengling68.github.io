import{_ as n,o as l,c as o,f as i}from"./app.c2c029cd.js";const r={};function d(p,e){return l(),o("div",null,[...e[0]||(e[0]=[i(`<h1 id="dom层级关系" tabindex="-1"><a class="header-anchor" href="#dom层级关系" aria-hidden="true">#</a> DOM层级关系</h1><h2 id="表单元素" tabindex="-1"><a class="header-anchor" href="#表单元素" aria-hidden="true">#</a> 表单元素</h2><ul><li>输入框内容，按钮内容，文本域内容，input，file</li><li>元素节点.value;</li></ul><h2 id="非表单元素" tabindex="-1"><a class="header-anchor" href="#非表单元素" aria-hidden="true">#</a> 非表单元素</h2><ul><li>innerHTML(文本+标签) innerText(设置纯文本)</li></ul><p>1、获取文本内容</p><pre><code>var myDiv = document.getElementsByTagName(&quot;div&quot;)[0];
...
</code></pre><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><ol><li><p>parentNode 父节点</p></li><li><p>childNodes 所有子节点</p></li><li><p>firstChild 第一个子节点 //与 childNodes 对应</p></li><li><p>lastChild 最后一个子节点</p></li><li><p>nextSibling 下一个兄弟节点</p></li><li><p>previousSibling 上一个兄弟节点</p></li><li><p>children 直接拿到元素子节点</p></li><li><p>firstElementChild 第一个元素子节点 //与 children 对应</p></li><li><p>lastElementChild 最后一个元素子节点</p></li><li><p>nextElementSibling 下一个元素兄弟节点</p></li><li><p>previousElementSibling 上一个元素兄弟节点</p></li></ol>`,36)])])}const a=n(r,[["render",d],["__file","12-DOM层级关系.html.vue"]]);export{a as default};
