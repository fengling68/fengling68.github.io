import{_ as n,o as s,c as a,f as t}from"./app.40d45622.js";const p={},o=t(`<h1 id="lottie" tabindex="-1"><a class="header-anchor" href="#lottie" aria-hidden="true">#</a> lottie</h1><p>很久之前写过的一个Lottie动画demo，这里贴下demo。</p><h2 id="使用步骤" tabindex="-1"><a class="header-anchor" href="#使用步骤" aria-hidden="true">#</a> 使用步骤</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
* lottie.vue文件
...
* 4、引入json文件
*/</span>
</code></pre></div><h2 id="lottie-vue-源码" tabindex="-1"><a class="header-anchor" href="#lottie-vue-源码" aria-hidden="true">#</a> lottie.vue 源码</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token operator">&lt;</span>template<span class="token operator">&gt;</span>
...
</code></pre></div><h2 id="lottie-vue-使用" tabindex="-1"><a class="header-anchor" href="#lottie-vue-使用" aria-hidden="true">#</a> lottie.vue 使用</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
* 渲染一个动画
*/</span>
...
<span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> animate1 <span class="token keyword">from</span> <span class="token string">&#39;./animate1.json&#39;</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> animate2 <span class="token keyword">from</span> <span class="token string">&#39;./animate2.json&#39;</span><span class="token punctuation">;</span>
...
</code></pre></div>`,8),e=[o];function c(r,l){return s(),a("div",null,e)}const i=n(p,[["render",c],["__file","lottie.html.vue"]]);export{i as default};
