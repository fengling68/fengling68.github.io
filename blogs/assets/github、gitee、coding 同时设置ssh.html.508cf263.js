...
PreferredAuthentications publickey
</code></pre></div><h2 id="_4、测试连接" tabindex="-1"><a class="header-anchor" href="#_4、测试连接" aria-hidden="true">#</a> 4、测试连接</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">ssh</span> <span class="token parameter variable">-T</span> git@github.com
