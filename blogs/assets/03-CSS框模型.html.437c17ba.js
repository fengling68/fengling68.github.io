import{_ as e,o as a,c as n,f as d}from"./app.140f40fb.js";const r={},p=d(`<h1 id="css框模型" tabindex="-1"><a class="header-anchor" href="#css框模型" aria-hidden="true">#</a> CSS框模型</h1><h2 id="盒子模型-方框模型、盒子属性" tabindex="-1"><a class="header-anchor" href="#盒子模型-方框模型、盒子属性" aria-hidden="true">#</a> 盒子模型(方框模型、盒子属性)</h2><pre><code>主要设置元素的：
