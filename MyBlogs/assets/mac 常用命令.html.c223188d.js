import{_ as n,o as s,c as e,f as t}from"./app.c2c029cd.js";const c={};function p(o,a){return s(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="mac-常用命令" tabindex="-1"><a class="header-anchor" href="#mac-常用命令" aria-hidden="true">#</a> mac 常用命令</h1><h2 id="mac-隐藏终端前的计算机名" tabindex="-1"><a class="header-anchor" href="#mac-隐藏终端前的计算机名" aria-hidden="true">#</a> mac 隐藏终端前的计算机名</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vim</span> /etc/bashrc
...
</code></pre></div>`,16)])])}const r=n(c,[["render",p],["__file","mac 常用命令.html.vue"]]);export{r as default};
