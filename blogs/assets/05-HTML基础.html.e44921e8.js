import{_ as e,o as t,c as a,f as n}from"./app.140f40fb.js";const r={},d=n(`<h1 id="html基础3" tabindex="-1"><a class="header-anchor" href="#html基础3" aria-hidden="true">#</a> HTML基础3</h1><h2 id="结构标记" tabindex="-1"><a class="header-anchor" href="#结构标记" aria-hidden="true">#</a> 结构标记</h2><h3 id="_1、作用" tabindex="-1"><a class="header-anchor" href="#_1、作用" aria-hidden="true">#</a> 1、作用</h3><pre><code>增强标签的语义性。HTML5出来之前，我们用div来表示页面章节，但是这些div都没有实际意义。这些标签只是我们提供给浏览器的指令，只是定义一个网页的某些部分，适合做容器。
