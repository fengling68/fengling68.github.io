import{_ as e,o as n,c as a,f as d}from"./app.a39d0481.js";const o={};function i(h,r){return n(),a("div",null,[...r[0]||(r[0]=[d(`<h1 id="数组常用方法" tabindex="-1"><a class="header-anchor" href="#数组常用方法" aria-hidden="true">#</a> 数组常用方法</h1><p>var arr = [10,&#39;hello&#39;,true, [20 , 30 , 40] ]; //二维数组</p><h2 id="push-方法" tabindex="-1"><a class="header-anchor" href="#push-方法" aria-hidden="true">#</a> push()方法</h2><pre><code>1、在末尾追加数组元素        arr.push(20 , &#39;姬如千泷&#39;);
2、返回值：返回新数组的长度
3、原数组发生改变
...
console.log(arr);
</code></pre>`,30)])])}const t=e(o,[["render",i],["__file","05-数组常用方法.html.vue"]]);export{t as default};
