import{_ as n,o as t,c as r,f as d}from"./app.c2c029cd.js";const o={};function i(a,e){return t(),r("div",null,[...e[0]||(e[0]=[d(`<h1 id="css基础" tabindex="-1"><a class="header-anchor" href="#css基础" aria-hidden="true">#</a> CSS基础</h1><h2 id="什么是css" tabindex="-1"><a class="header-anchor" href="#什么是css" aria-hidden="true">#</a> 什么是CSS？</h2><pre><code>CSS：Cascading Style Sheet   层叠样式表、级联样式表、样式表
...
对同一个元素定义样式时，以权值高的为准。
</code></pre>`,30)])])}const p=n(o,[["render",i],["__file","01-CSS基础.html.vue"]]);export{p as default};
