import{_ as e,o as a,c as r,f as d}from"./app.c2c029cd.js";const n={};function l(h,t){return a(),r("div",null,[...t[0]||(t[0]=[d(`<h1 id="html基础2" tabindex="-1"><a class="header-anchor" href="#html基础2" aria-hidden="true">#</a> HTML基础2</h1><h2 id="什么是url" tabindex="-1"><a class="header-anchor" href="#什么是url" aria-hidden="true">#</a> 什么是URL</h2><pre><code>URL（Uniform Resource Locator）：统一资源定位器，路径
URL作用：用来标识网络中的资源位置
...
&lt;dl&gt;
    ...
    &lt;dd&gt;列表数据&lt;/dd&gt;
&lt;/dl&gt;
</code></pre><h3 id="_4、列表的嵌套" tabindex="-1"><a class="header-anchor" href="#_4、列表的嵌套" aria-hidden="true">#</a> 4、列表的嵌套</h3>`,39)])])}const i=e(n,[["render",l],["__file","04-HTML基础.html.vue"]]);export{i as default};
