import{_ as e,o as r,c as a,f as o}from"./app.e56a07d8.js";const t={},n=o(`<h1 id="正则表达式" tabindex="-1"><a class="header-anchor" href="#正则表达式" aria-hidden="true">#</a> 正则表达式</h1><ul><li>正则表达式：一种模式，一种标准。检索一段文本是否符合要求。</li><li>强大的字符匹配工具</li><li>正则表达式具有贪婪模式：优先匹配最多的</li></ul><p>1、字面量方式</p><pre><code>var reg1 = /字符/gi;
