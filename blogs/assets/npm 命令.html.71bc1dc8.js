import{_ as e,r as t,o,c,a as n,b as s,d as p,f as r}from"./app.7e19d012.js";const l={},i=n("h1",{id:"npm-命令",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#npm-命令","aria-hidden":"true"},"#"),s(" npm 命令")],-1),m={href:"https://www.npmjs.com/",target:"_blank",rel:"noopener noreferrer"},h=r(`<h2 id="查询设置镜像" tabindex="-1"><a class="header-anchor" href="#查询设置镜像" aria-hidden="true">#</a> 查询设置镜像</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查询当前配置的镜像</span>
...
</code></pre></div>`,4);function d(u,f){const a=t("ExternalLinkIcon");return o(),c("div",null,[i,n("p",null,[n("a",m,[s("NPM官网"),p(a)])]),h])}const _=e(l,[["render",d],["__file","npm 命令.html.vue"]]);export{_ as default};
