import{_ as e,o as a,c as o,f as t}from"./app.a39d0481.js";const i={};function h(s,n){return a(),o("div",null,[...n[0]||(n[0]=[t(`<h1 id="this关键字" tabindex="-1"><a class="header-anchor" href="#this关键字" aria-hidden="true">#</a> this关键字</h1><pre><code>this对象：每个函数中都会有this对象。 context:上下文对象
this总是指向调用该函数的对象。
