...
</code></pre></div><h2 id="shell-判断目录、文件是否存在" tabindex="-1"><a class="header-anchor" href="#shell-判断目录、文件是否存在" aria-hidden="true">#</a> shell 判断目录、文件是否存在</h2>`,6)),s("p",null,[s("a",u,[n[2]||(n[2]=t("shell 判断文件夹或文件是否存在",-1)),o(e)])]),n[5]||(n[5]=a(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 判断目录是否存在</span>
...
<span class="token keyword">fi</span>
</code></pre></div>`,1))])}const m=d(l,[["render",k],["__file","linux 命令.html.vue"]]);export{m as default};
