import{_ as e,o as n,c as a,f as r}from"./app.d9b83bc9.js";const d={},o=r(`<h1 id="js事件" tabindex="-1"><a class="header-anchor" href="#js事件" aria-hidden="true">#</a> JS事件</h1><h2 id="什么是事件" tabindex="-1"><a class="header-anchor" href="#什么是事件" aria-hidden="true">#</a> 什么是事件</h2><pre><code>用户或浏览器执行的某个动作
