import{_ as e,o as a,c as d,f as t}from"./app.873480e4.js";const r={},o=t(`<h1 id="date日期和时间" tabindex="-1"><a class="header-anchor" href="#date日期和时间" aria-hidden="true">#</a> Date日期和时间</h1><h2 id="创建日期" tabindex="-1"><a class="header-anchor" href="#创建日期" aria-hidden="true">#</a> 创建日期</h2><pre><code>var date1 = new Date();
console.log(date1);
