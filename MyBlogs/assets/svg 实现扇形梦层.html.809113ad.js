import{_ as s,o as a,c as t,f as p}from"./app.a39d0481.js";const o={};function e(c,n){return a(),t("div",null,[...n[0]||(n[0]=[p(`<h1 id="svg-实现扇形蒙层" tabindex="-1"><a class="header-anchor" href="#svg-实现扇形蒙层" aria-hidden="true">#</a> svg 实现扇形蒙层</h1><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div>`,2)])])}const l=s(o,[["render",e],["__file","svg 实现扇形梦层.html.vue"]]);export{l as default};
