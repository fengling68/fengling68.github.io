import{_ as e,r as t,o,c,a as n,b as a,d as p,f as r}from"./app.7092ccdd.js";const l={},i=n("h1",{id:"npm-命令",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#npm-命令","aria-hidden":"true"},"#"),a(" npm 命令")],-1),m={href:"https://www.npmjs.com/",target:"_blank",rel:"noopener noreferrer"},d=r(`<h2 id="查询设置镜像" tabindex="-1"><a class="header-anchor" href="#查询设置镜像" aria-hidden="true">#</a> 查询设置镜像</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查询当前配置的镜像</span>
