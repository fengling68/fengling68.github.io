...
<span class="token punctuation">]</span><span class="token punctuation">,</span>
</code></pre></div><h2 id="配置用户代码片段" tabindex="-1"><a class="header-anchor" href="#配置用户代码片段" aria-hidden="true">#</a> 配置用户代码片段</h2>`,12)),s("p",null,[n[1]||(n[1]=a("1、command + shift + p，打开面板； 2、输入 ",-1)),n[2]||(n[2]=s("code",null,"> snippet",-1)),n[3]||(n[3]=a("，选择 “首选项：配置用户代码片段”； 3、快速生成代码片段配置：",-1)),s("a",i,[n[0]||(n[0]=a("https://snippet-generator.app/",-1)),c(o)])]),n[5]||(n[5]=t(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 配置示例</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,1))])}const g=p(l,[["render",k],["__file","vscode 配置.html.vue"]]);export{g as default};
