import{_ as e,o as r,c as a,f as n}from"./app.e56a07d8.js";const t={},d=n(`<h1 id="_2d动画" tabindex="-1"><a class="header-anchor" href="#_2d动画" aria-hidden="true">#</a> 2D动画</h1><pre><code>转换是使元素改变形状、尺寸和位置的一种效果。
移动、缩放、旋转、拉伸倾斜
