import{_ as i,r as p,o as r,c,a as n,b as s,d as e,f as o}from"./app.a39d0481.js";const l={},d={href:"https://www.bootcss.com/p/git-guide/",target:"_blank",rel:"noopener noreferrer"},u={href:"http://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://www.jianshu.com/p/b23cd00cffa6",target:"_blank",rel:"noopener noreferrer"};function h(k,a){const t=p("ExternalLinkIcon");return r(),c("div",null,[a[6]||(a[6]=n("h1",{id:"git-常用命令和问题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#git-常用命令和问题","aria-hidden":"true"},"#"),s(" git 常用命令和问题")],-1)),a[7]||(a[7]=n("p",null,"本文档多为个人学习生活中最常用到的命令汇总，和遇见的问题及解决方案，大部分在其他网络博客或文章中都有提及，只是每次碰到相同问题还是要重新查文档，很不方便，因此将遇到的问题汇总至本文档里。方便学习和查找。",-1)),a[8]||(a[8]=n("h2",{id:"推荐资料",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#推荐资料","aria-hidden":"true"},"#"),s(" 推荐资料")],-1)),n("p",null,[n("a",d,[a[0]||(a[0]=s("git简易指南",-1)),e(t)])]),n("p",null,[n("a",u,[a[1]||(a[1]=s("常用git命令清单 阮一峰",-1)),e(t)])]),a[9]||(a[9]=o(`<h2 id="设置全局用户名和邮箱" tabindex="-1"><a class="header-anchor" href="#设置全局用户名和邮箱" aria-hidden="true">#</a> 设置全局用户名和邮箱</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> <span class="token parameter variable">-l</span>
...
</code></pre></div><h3 id="fatal-authentication-failed-for" tabindex="-1"><a class="header-anchor" href="#fatal-authentication-failed-for" aria-hidden="true">#</a> fatal: Authentication failed for</h3><p><span style="color:#3eaf7c;">问题场景：</span> 电脑A有添加ssh，可正常使用ssh形式的链接拉取仓库代码；电脑B未添加ssh，想要拉去远端仓库，只能使用http像是链接；在使用http像是链接时需要输入用户名和密码，则很容易出现上述问题。</p><p><span style="color:#3eaf7c;">问题原因：</span> 在使用http形式输入密码时出错，系统缓存了错误密码，且不再重复提示输入密码，而导致每次都提示认证失败。</p>`,35)),n("p",null,[a[3]||(a[3]=n("span",{style:{color:"#3eaf7c"}},"Window解决：",-1)),a[4]||(a[4]=s(" window系统解决方案可参考此文章：",-1)),n("a",g,[a[2]||(a[2]=s("https://www.jianshu.com/p/b23cd00cffa6",-1)),e(t)]),a[5]||(a[5]=s("。",-1))]),a[10]||(a[10]=o(`<p><span style="color:#3eaf7c;">Mac解决方案：</span> 本人使用Mac电脑出现上述问题，上网搜索尝试过多种方案，都未成功，后来误打误撞，竟然解决了，这里贴下解决过程。</p><p>第一步：在git上创建项目令牌，此处已本人使用的企业版coding为例 <img src="https://fengling68.github.io/imgbed/images/1576935352-2822x560.webp" alt="git-02"></p><p>第二步：使用项目令牌拼接如下格式url</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> setting <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>第三步：git命令使用新url直接clone代码或者重新设置remote后pull、push代码均可正常使用。查看Mac钥匙串程序，可以看到如下凭证。 <img src="https://fengling68.github.io/imgbed/images/1576935352-1758x636.webp" alt="git-03"></p>`,5))])}const m=i(l,[["render",h],["__file","git 常用命令和问题.html.vue"]]);export{m as default};
