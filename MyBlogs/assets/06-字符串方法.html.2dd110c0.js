import{_ as r,o as n,c as o,f as a}from"./app.a39d0481.js";const t={};function s(c,e){return n(),o("div",null,[...e[0]||(e[0]=[a(`<h1 id="字符串方法" tabindex="-1"><a class="header-anchor" href="#字符串方法" aria-hidden="true">#</a> 字符串方法</h1><h2 id="字符串的创建方式" tabindex="-1"><a class="header-anchor" href="#字符串的创建方式" aria-hidden="true">#</a> 字符串的创建方式</h2><p>1、字面量方式</p><pre><code>var str1 = &quot;123abc&quot;;
...
</code></pre>`,33)])])}const i=r(t,[["render",s],["__file","06-字符串方法.html.vue"]]);export{i as default};
