import{_ as t,o as n,c as r,f as a}from"./app.c2c029cd.js";const o={};function f(l,e){return n(),r("div",null,[...e[0]||(e[0]=[a(`<h1 id="js运动函数及封装" tabindex="-1"><a class="header-anchor" href="#js运动函数及封装" aria-hidden="true">#</a> JS运动函数及封装</h1><h2 id="图片滚动" tabindex="-1"><a class="header-anchor" href="#图片滚动" aria-hidden="true">#</a> 图片滚动</h2><pre><code>var timer;
...
</code></pre>`,12)])])}const i=t(o,[["render",f],["__file","15-JS运动函数及封装.html.vue"]]);export{i as default};
