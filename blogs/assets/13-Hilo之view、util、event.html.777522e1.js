import{_ as e,o as n,c as t,f as a}from"./app.7e19d012.js";const i={},o=a(`<h1 id="hilo之view、util、event" tabindex="-1"><a class="header-anchor" href="#hilo之view、util、event" aria-hidden="true">#</a> Hilo之view、util、event</h1><h2 id="view" tabindex="-1"><a class="header-anchor" href="#view" aria-hidden="true">#</a> view</h2><h3 id="_1、stage-舞台" tabindex="-1"><a class="header-anchor" href="#_1、stage-舞台" aria-hidden="true">#</a> 1、Stage 舞台</h3><pre><code>var stage = new Hilo.Stage({
    renderType: &#39;canvas&#39;,
