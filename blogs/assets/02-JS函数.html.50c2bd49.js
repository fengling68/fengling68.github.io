import{_ as n,o as e,c as a,f as r}from"./app.93195575.js";const o={},d=r(`<h1 id="js函数" tabindex="-1"><a class="header-anchor" href="#js函数" aria-hidden="true">#</a> JS函数</h1><h2 id="函数是一等公民" tabindex="-1"><a class="header-anchor" href="#函数是一等公民" aria-hidden="true">#</a> 函数是一等公民</h2><pre><code>函数命名规则标识符 命名规则 驼峰命名  语义化  可以$开头命名
函数名称不要大写, 大写的是构造函数。
