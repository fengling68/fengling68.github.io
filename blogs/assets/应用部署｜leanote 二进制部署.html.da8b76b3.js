import{_ as t,r as e,o,c as p,a,b as n,d as c,f as l}from"./app.b0016746.js";const d={},u=a("h1",{id:"leanote-二进制部署",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#leanote-二进制部署","aria-hidden":"true"},"#"),n(" leanote 二进制部署")],-1),i={href:"https://51.ruyo.net/2922.html",target:"_blank",rel:"noopener noreferrer"},r=l(`<h2 id="下载文件" tabindex="-1"><a class="header-anchor" href="#下载文件" aria-hidden="true">#</a> 下载文件</h2><ul><li>leanote二进制版 http://leanote.org/#download</li><li>MongoDB http://dl.mongodb.org/dl/win32/x86_64</li><li>leanote客户端 https://leanote.com/</li><li>Robo 3T https://robomongo.org/download</li></ul><h2 id="安装步骤" tabindex="-1"><a class="header-anchor" href="#安装步骤" aria-hidden="true">#</a> 安装步骤</h2><div class="language-text" data-ext="text"><pre class="language-text"><code>1、在 \` D:\\mongodb \` 下新建data（db , log）文件夹
