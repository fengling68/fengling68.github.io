import{T as P}from"./ToolHeader-DSDHbRKd.js";import{d as H,k as u,e as y,F,j as R,w as p,b as S,o as M,l as h,f as g,r as b,c as C,D as J}from"./index-9BdGbTFy.js";const U={class:"md-tool"},W={class:"md-toolbar"},Y={class:"tool-cols"},G={class:"md-stats"},K=["innerHTML"],j=`# Markdown 编辑预览
...
`).length;return{chars:s,words:e,lines:l}}),w=b(null),T=b(null);function f(s,e,l){var r;const t=(r=w.value)==null?void 0:r.$el;if(!t){n.value+=s+l+e;return}const o=t.selectionStart,a=t.selectionEnd,i=n.value.slice(o,a)||l;n.value=n.value.slice(0,o)+s+i+e+n.value.slice(a),J(()=>{t.focus(),t.selectionStart=o+s.length,t.selectionEnd=o+s.length+i.length})}function m(s){var o;const e=(o=w.value)==null?void 0:o.$el,l=(e==null?void 0:e.selectionStart)??n.value.length,t=n.value.lastIndexOf(`
...
`)&&(t+=`
`),n.value=t}function D(){var s;n.value&&((s=navigator.clipboard)==null||s.writeText(n.value),A.value=!0,setTimeout(()=>A.value=!1,1200))}return(s,e)=>{const l=S("AtomButton"),t=S("AtomInputTextArea"),o=S("AtomPanel");return M(),H("div",U,[u(P,{title:"Markdown 编辑预览",desc:"实时编辑与预览 Markdown，支持工具条快捷插入、示例填充与格式美化"}),y("div",W,[(M(),H(F,null,R(N,a=>u(l,{key:a.label,size:"s",title:a.title,onClick:i=>a.run()},{default:p(()=>[h(g(a.label),1)]),_:2},1032,["title","onClick"])),64))]),y("div",Y,[u(o,{title:"内容输入",column:"",class:"md-edit"},{"head-ops":p(()=>[y("span",G,g(k.value.chars)+" 字符 · "+g(k.value.words)+" 词 · "+g(k.value.lines)+" 行",1),u(l,{size:"s",variant:"primary",onClick:I},{default:p(()=>[...e[1]||(e[1]=[h("添加示例",-1)])]),_:1}),u(l,{size:"s",onClick:O},{default:p(()=>[...e[2]||(e[2]=[h("美化",-1)])]),_:1}),u(l,{size:"s",onClick:V},{default:p(()=>[...e[3]||(e[3]=[h("清除",-1)])]),_:1}),u(l,{size:"s",disabled:!n.value,onClick:D},{default:p(()=>[h(g(A.value?"已复制":"复制"),1)]),_:1},8,["disabled"])]),default:p(()=>[u(t,{ref_key:"editor",ref:w,modelValue:n.value,"onUpdate:modelValue":e[0]||(e[0]=a=>n.value=a),size:"xxxl",spellcheck:"false"},null,8,["modelValue"])]),_:1}),u(o,{title:"预览",class:"md-preview"},{"head-ops":p(()=>[u(l,{size:"s",disabled:!q.value,onClick:B},{default:p(()=>[h(g($.value?"已复制":"复制 HTML"),1)]),_:1},8,["disabled"])]),default:p(()=>[y("div",{ref_key:"previewBody",ref:T,class:"md-preview__body md-html",innerHTML:q.value},null,8,K)]),_:1})])])}}};export{ee as default};
