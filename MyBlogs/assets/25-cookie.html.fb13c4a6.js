import{_ as o,o as n,c as a,f as i}from"./app.a39d0481.js";const t={};function r(c,e){return n(),a("div",null,[...e[0]||(e[0]=[i(`<h1 id="cookie" tabindex="-1"><a class="header-anchor" href="#cookie" aria-hidden="true">#</a> cookie</h1><h2 id="http协议" tabindex="-1"><a class="header-anchor" href="#http协议" aria-hidden="true">#</a> HTTP协议</h2><pre><code>超文本传输协议, 是一个应用层的协议，由请求和响应构成。
...
alert(val);
</code></pre>`,27)])])}const h=o(t,[["render",r],["__file","25-cookie.html.vue"]]);export{h as default};
