import{_ as n,o as t,c as a,f as i}from"./app.a39d0481.js";const o={};function r(d,e){return t(),a("div",null,[...e[0]||(e[0]=[i(`<h1 id="hilo之view、util、event" tabindex="-1"><a class="header-anchor" href="#hilo之view、util、event" aria-hidden="true">#</a> Hilo之view、util、event</h1><h2 id="view" tabindex="-1"><a class="header-anchor" href="#view" aria-hidden="true">#</a> view</h2><h3 id="_1、stage-舞台" tabindex="-1"><a class="header-anchor" href="#_1、stage-舞台" aria-hidden="true">#</a> 1、Stage 舞台</h3><pre><code>var stage = new Hilo.Stage({
    renderType: &#39;canvas&#39;,
...
</code></pre>`,32)])])}const l=n(o,[["render",r],["__file","13-Hilo之view、util、event.html.vue"]]);export{l as default};
