import{_ as t,o as d,c as o,f as p}from"./app.c2c029cd.js";const c={};function r(n,e){return d(),o("div",null,[...e[0]||(e[0]=[p(`<h1 id="css3选择器" tabindex="-1"><a class="header-anchor" href="#css3选择器" aria-hidden="true">#</a> CSS3选择器</h1><h2 id="通用兄弟选择器" tabindex="-1"><a class="header-anchor" href="#通用兄弟选择器" aria-hidden="true">#</a> 通用兄弟选择器</h2><p>selector1~selector2{} 可以不相邻</p><p>例：div~p{ } 为所有相同的父元素中位于 div 元素之后的所有 p 元素设置样式</p><pre><code>&lt;div&gt;&lt;/div&gt;
   &lt;p&gt;&lt;/p&gt;
   &lt;p&gt;&lt;/p&gt;
&lt;span&gt;&lt;/span&gt;
   &lt;p&gt;&lt;/p&gt;
...
</code></pre>`,51)])])}const a=t(c,[["render",r],["__file","10-CSS3选择器.html.vue"]]);export{a as default};
