import{_ as a,o as r,c as n,f as d}from"./app.c2c029cd.js";const o={};function c(i,e){return r(),n("div",null,[...e[0]||(e[0]=[d(`<h1 id="css背景" tabindex="-1"><a class="header-anchor" href="#css背景" aria-hidden="true">#</a> CSS背景</h1><h2 id="背景颜色" tabindex="-1"><a class="header-anchor" href="#背景颜色" aria-hidden="true">#</a> 背景颜色</h2><pre><code>background-color：red;       background-color不能继承
...
</code></pre>`,30)])])}const p=a(o,[["render",c],["__file","04-CSS背景.html.vue"]]);export{p as default};
