import{_ as t,o as n,c as a,f as o}from"./app.c2c029cd.js";const r={};function d(h,e){return n(),a("div",null,[...e[0]||(e[0]=[o(`<h1 id="html基础1" tabindex="-1"><a class="header-anchor" href="#html基础1" aria-hidden="true">#</a> HTML基础1</h1><h2 id="万维网" tabindex="-1"><a class="header-anchor" href="#万维网" aria-hidden="true">#</a> 万维网</h2><pre><code>前端是指页面的表现形式，浏览器负责解释html页面
万维网联盟 WWW
元素属性（元素的最完整表现）
...
行内元素不能嵌套块级元素
</code></pre>`,22)])])}const l=t(r,[["render",d],["__file","03-HTML基础.html.vue"]]);export{l as default};
