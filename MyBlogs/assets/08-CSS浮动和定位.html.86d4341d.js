import{_ as a,o as n,c as r,f as d}from"./app.a39d0481.js";const o={};function t(c,e){return n(),r("div",null,[...e[0]||(e[0]=[d(`<h1 id="css浮动和定位" tabindex="-1"><a class="header-anchor" href="#css浮动和定位" aria-hidden="true">#</a> CSS浮动和定位</h1><h2 id="定位分类" tabindex="-1"><a class="header-anchor" href="#定位分类" aria-hidden="true">#</a> 定位分类</h2><p>定位：元素在网页中出现的位置</p><pre><code>(1)普通流定位
(2)浮动定位 float
(3)相对定位 relative
(4)绝对定位 absolute
(5)固定定位 fixed
...
使用场合：小广告; 返回顶部。
</code></pre>`,24)])])}const h=a(o,[["render",t],["__file","08-CSS浮动和定位.html.vue"]]);export{h as default};
