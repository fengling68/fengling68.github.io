import{_ as n,o as t,c as o,f as a}from"./app.a39d0481.js";const r={};function d(c,e){return t(),o("div",null,[...e[0]||(e[0]=[a(`<h1 id="js事件对象" tabindex="-1"><a class="header-anchor" href="#js事件对象" aria-hidden="true">#</a> JS事件对象</h1><h2 id="事件对象" tabindex="-1"><a class="header-anchor" href="#事件对象" aria-hidden="true">#</a> 事件对象</h2><pre><code>信息库：该事件的所有信息属性和方法，如鼠标位置或键盘键码
每个事件都有一个事件对象。
...
</code></pre>`,7)])])}const s=n(r,[["render",d],["__file","17-JS事件对象.html.vue"]]);export{s as default};
