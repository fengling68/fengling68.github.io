import{_ as e,o as t,c as o,f as n}from"./app.7092ccdd.js";const r={},d=n(`<h1 id="dom样式和屏幕尺寸" tabindex="-1"><a class="header-anchor" href="#dom样式和屏幕尺寸" aria-hidden="true">#</a> DOM样式和屏幕尺寸</h1><h2 id="css样式操作" tabindex="-1"><a class="header-anchor" href="#css样式操作" aria-hidden="true">#</a> CSS样式操作</h2><pre><code>在JS中，如果样式名称有连字符，去掉连字符，驼峰命名
