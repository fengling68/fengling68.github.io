import{_ as e,o as a,c as o,f as r}from"./app.c2c029cd.js";const d={};function c(t,n){return a(),o("div",null,[...n[0]||(n[0]=[r(`<h1 id="匿名函数" tabindex="-1"><a class="header-anchor" href="#匿名函数" aria-hidden="true">#</a> 匿名函数</h1><h2 id="匿名函数-1" tabindex="-1"><a class="header-anchor" href="#匿名函数-1" aria-hidden="true">#</a> 匿名函数</h2><pre><code>引用数据类型(3种)：对象，数组，对象
...
2、匿名函数创建方式
3、原始方式，new的方式，底层常用
</code></pre>`,13)])])}const h=e(d,[["render",c],["__file","03-匿名函数.html.vue"]]);export{h as default};
