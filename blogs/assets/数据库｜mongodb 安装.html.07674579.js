import{_ as t,r as c,o as d,c as r,a,b as n,d as o,f as e}from"./app.140f40fb.js";const l={},i=e(`<h1 id="mongodb-安装" tabindex="-1"><a class="header-anchor" href="#mongodb-安装" aria-hidden="true">#</a> mongodb 安装</h1><h2 id="mongodb-安装和启动" tabindex="-1"><a class="header-anchor" href="#mongodb-安装和启动" aria-hidden="true">#</a> mongodb 安装和启动</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入 /usr/local</span>
