import{_ as e,o as t,c as n,f as o}from"./app.e56a07d8.js";const a={},r=o(`<h1 id="dom文档对象模型" tabindex="-1"><a class="header-anchor" href="#dom文档对象模型" aria-hidden="true">#</a> DOM文档对象模型</h1><h2 id="dom节点" tabindex="-1"><a class="header-anchor" href="#dom节点" aria-hidden="true">#</a> DOM节点</h2><pre><code>HTML的所有内容都是节点
文档节点  元素节点  属性节点   文本节点
