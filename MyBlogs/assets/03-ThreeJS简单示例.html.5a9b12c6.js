import{_ as t,o as i,c as r,a as n,b as a}from"./app.a39d0481.js";const o={};function c(l,e){return i(),r("div",null,[...e[0]||(e[0]=[n("h1",{id:"three-js简单示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#three-js简单示例","aria-hidden":"true"},"#"),a(" three.js简单示例")],-1),n("p",null,"/* 使用相机将场景渲染到网页上 1、初始化场景 2、初始化相机 3、初始化渲染器 4、实时渲染 5、初始化光源 6、画正方体并在 实时渲染 中使物体运动 7、画渐变线条 实时渲染 中使物体运动 */",-1),n("pre",null,[n("code",null,`var scene;          // 场景
var camera;         // 相机
var renderer;       // 渲染器
...
`)],-1)])])}const d=t(o,[["render",c],["__file","03-ThreeJS简单示例.html.vue"]]);export{d as default};
