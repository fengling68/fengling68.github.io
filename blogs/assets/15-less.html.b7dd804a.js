import{_ as n,o as e,c as r,f as a}from"./app.e56a07d8.js";const o={},s=a(`<h1 id="less" tabindex="-1"><a class="header-anchor" href="#less" aria-hidden="true">#</a> less</h1><h2 id="三种使用方式" tabindex="-1"><a class="header-anchor" href="#三种使用方式" aria-hidden="true">#</a> 三种使用方式</h2><pre><code>1、引入less文件，将写好的less文件，编译为CSS文件 ———— 基本不用
2、在本地进行编译, 使用 koala
