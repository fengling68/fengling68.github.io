import{_ as n,o,c as e,f as t}from"./app.fa375d3e.js";const r={},a=t(`<h1 id="bom浏览器模型" tabindex="-1"><a class="header-anchor" href="#bom浏览器模型" aria-hidden="true">#</a> BOM浏览器模型</h1><h2 id="js三大模块" tabindex="-1"><a class="header-anchor" href="#js三大模块" aria-hidden="true">#</a> JS三大模块</h2><ul><li>ECMAScript：变量、表达式、运算符、选择、循环、函数、数组、字符串、Math、Date</li><li>BOM：browser object model 浏览器对象模型——JS操作浏览器</li><li>DOM：文档对象模型</li></ul><h2 id="js控制浏览器-window对象-工具包" tabindex="-1"><a class="header-anchor" href="#js控制浏览器-window对象-工具包" aria-hidden="true">#</a> JS控制浏览器 window对象 工具包</h2><pre><code>function fn(){}   fn();
在全局声明的函数，属于window
