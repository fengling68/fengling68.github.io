import{_ as a,o as d,c as t,f as r}from"./app.c2c029cd.js";const p={};function n(o,e){return d(),t("div",null,[...e[0]||(e[0]=[r(`<h1 id="date日期和时间" tabindex="-1"><a class="header-anchor" href="#date日期和时间" aria-hidden="true">#</a> Date日期和时间</h1><h2 id="创建日期" tabindex="-1"><a class="header-anchor" href="#创建日期" aria-hidden="true">#</a> 创建日期</h2><pre><code>var date1 = new Date();
console.log(date1);
...
</code></pre>`,43)])])}const i=a(p,[["render",n],["__file","09-Date日期和时间.html.vue"]]);export{i as default};
