import{_ as r,o as a,c as o,f as t}from"./app.c2c029cd.js";const n={};function c(i,e){return a(),o("div",null,[...e[0]||(e[0]=[t(`<h1 id="正则表达式" tabindex="-1"><a class="header-anchor" href="#正则表达式" aria-hidden="true">#</a> 正则表达式</h1><ul><li>正则表达式：一种模式，一种标准。检索一段文本是否符合要求。</li><li>强大的字符匹配工具</li><li>正则表达式具有贪婪模式：优先匹配最多的</li></ul><p>1、字面量方式</p><pre><code>var reg1 = /字符/gi;
...
</code></pre><h2 id="正则表达式模式" tabindex="-1"><a class="header-anchor" href="#正则表达式模式" aria-hidden="true">#</a> 正则表达式模式</h2><ul><li><p><code>^$</code>模式</p></li><li><p>用于表单验证，规定输入的内容规则。</p></li><li><p>非<code>^$</code>模式</p></li><li><p>用于匹配字符串</p></li></ul>`,33)])])}const l=r(n,[["render",c],["__file","20-正则表达式.html.vue"]]);export{l as default};
