import{_ as e,o as a,c as r,f as n}from"./app.fa375d3e.js";const d={},o=n(`<h1 id="css表格和列表" tabindex="-1"><a class="header-anchor" href="#css表格和列表" aria-hidden="true">#</a> CSS表格和列表</h1><h2 id="常用样式" tabindex="-1"><a class="header-anchor" href="#常用样式" aria-hidden="true">#</a> 常用样式</h2><pre><code>文本、字体格式化属性
背景属性：颜色、字体
内边距：padding
尺寸：width height
边框：border
