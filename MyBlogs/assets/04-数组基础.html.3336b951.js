import{_ as n,o as e,c as a,f as o}from"./app.c2c029cd.js";const t={};function i(d,r){return e(),a("div",null,[...r[0]||(r[0]=[o(`<h1 id="数组基础" tabindex="-1"><a class="header-anchor" href="#数组基础" aria-hidden="true">#</a> 数组基础</h1><pre><code>数组Array：值的有序集合
数组中的数据————元素 元素之间,隔开
数组中数据类型没有限制，弱类型的体现
...
</code></pre>`,19)])])}const u=n(t,[["render",i],["__file","04-数组基础.html.vue"]]);export{u as default};
