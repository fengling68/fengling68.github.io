import{_ as n,o as a,c as r,f as d}from"./app.c2c029cd.js";const o={};function h(c,e){return a(),r("div",null,[...e[0]||(e[0]=[d(`<h1 id="js事件" tabindex="-1"><a class="header-anchor" href="#js事件" aria-hidden="true">#</a> JS事件</h1><h2 id="什么是事件" tabindex="-1"><a class="header-anchor" href="#什么是事件" aria-hidden="true">#</a> 什么是事件</h2><pre><code>用户或浏览器执行的某个动作
...
</code></pre>`,29)])])}const t=n(o,[["render",h],["__file","16-JS事件.html.vue"]]);export{t as default};
