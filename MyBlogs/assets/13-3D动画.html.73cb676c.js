import{_ as n,o as r,c as a,f as o}from"./app.a39d0481.js";const t={};function i(d,e){return r(),a("div",null,[...e[0]||(e[0]=[o(`<h1 id="_3d动画" tabindex="-1"><a class="header-anchor" href="#_3d动画" aria-hidden="true">#</a> 3D动画</h1><h2 id="属性perspective" tabindex="-1"><a class="header-anchor" href="#属性perspective" aria-hidden="true">#</a> 属性perspective</h2><pre><code>单位：px；
...
触发：过渡效果由用户的行为进行触发（点击、鼠标悬停）
 ...
 paused：暂停
 running：播放
</code></pre></li></ol>`,16)])])}const p=n(t,[["render",i],["__file","13-3D动画.html.vue"]]);export{p as default};
