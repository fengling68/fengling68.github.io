import{_ as t,o,c as n,f as r}from"./app.a39d0481.js";const d={};function a(c,e){return o(),n("div",null,[...e[0]||(e[0]=[r(`<h1 id="dom样式和屏幕尺寸" tabindex="-1"><a class="header-anchor" href="#dom样式和屏幕尺寸" aria-hidden="true">#</a> DOM样式和屏幕尺寸</h1><h2 id="css样式操作" tabindex="-1"><a class="header-anchor" href="#css样式操作" aria-hidden="true">#</a> CSS样式操作</h2><pre><code>在JS中，如果样式名称有连字符，去掉连字符，驼峰命名
...
</code></pre>`,30)])])}const h=t(d,[["render",a],["__file","14-DOM样式和屏幕尺寸.html.vue"]]);export{h as default};
