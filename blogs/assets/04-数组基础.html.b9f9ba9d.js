import{_ as r,o as n,c as e,f as o}from"./app.40d45622.js";const a={},t=o(`<h1 id="数组基础" tabindex="-1"><a class="header-anchor" href="#数组基础" aria-hidden="true">#</a> 数组基础</h1><pre><code>数组Array：值的有序集合
数组中的数据————元素 元素之间,隔开
数组中数据类型没有限制，弱类型的体现
