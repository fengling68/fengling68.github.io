import{_ as t,o,c as l,a as e,b as a}from"./app.a39d0481.js";const d={};function c(r,n){return o(),l("div",null,[...n[0]||(n[0]=[e("h1",{id:"dom元素操作",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#dom元素操作","aria-hidden":"true"},"#"),a(" DOM元素操作")],-1),e("p",null,"元素节点的操作：创建、添加、插入、删除、替换、复制",-1),e("pre",null,[e("code",null,`<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
...
<\/script>
`)],-1)])])}const p=t(d,[["render",c],["__file","13-DOM元素操作.html.vue"]]);export{p as default};
