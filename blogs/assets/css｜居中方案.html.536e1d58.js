import{_ as n,o as s,c as a,f as p}from"./app.fa375d3e.js";const t={},o=p(`<h1 id="居中方案" tabindex="-1"><a class="header-anchor" href="#居中方案" aria-hidden="true">#</a> 居中方案</h1><h2 id="水平居中" tabindex="-1"><a class="header-anchor" href="#水平居中" aria-hidden="true">#</a> 水平居中</h2><h3 id="文字" tabindex="-1"><a class="header-anchor" href="#文字" aria-hidden="true">#</a> 文字</h3><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token comment">/* 适用于文字、链接、inline、inline-block、inline-table和inline-flex的元素。 */</span>
