import{_ as t,o,c as e,f as i}from"./app.c2c029cd.js";const a={};function l(c,n){return o(),e("div",null,[...n[0]||(n[0]=[i(`<h1 id="懒加载和滚动加载" tabindex="-1"><a class="header-anchor" href="#懒加载和滚动加载" aria-hidden="true">#</a> 懒加载和滚动加载</h1><h2 id="懒加载" tabindex="-1"><a class="header-anchor" href="#懒加载" aria-hidden="true">#</a> 懒加载</h2><pre><code>/*******************  懒加载 lazyLoad  ********************/
一、懒加载优点
    1、节省网络资源
    2、对用户体验, 使用友好
    3、对服务器而言, 负载压力减少
...
</code></pre>`,5)])])}const s=t(a,[["render",l],["__file","19-懒加载和滚动加载.html.vue"]]);export{s as default};
