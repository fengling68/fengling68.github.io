import{_ as e,o as a,c as n,f as r}from"./app.70e3165a.js";const d={},o=r(`<h1 id="css浮动和定位" tabindex="-1"><a class="header-anchor" href="#css浮动和定位" aria-hidden="true">#</a> CSS浮动和定位</h1><h2 id="定位分类" tabindex="-1"><a class="header-anchor" href="#定位分类" aria-hidden="true">#</a> 定位分类</h2><p>定位：元素在网页中出现的位置</p><pre><code>(1)普通流定位
(2)浮动定位 float
(3)相对定位 relative
(4)绝对定位 absolute
(5)固定定位 fixed
