import{_ as s,o as a,c as t,f as p}from"./app.a39d0481.js";const o={};function e(c,n){return a(),t("div",null,[...n[0]||(n[0]=[p(`<h1 id="video视频组件" tabindex="-1"><a class="header-anchor" href="#video视频组件" aria-hidden="true">#</a> video视频组件</h1><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div>`,2)])])}const l=s(o,[["render",e],["__file","10-video.html.vue"]]);export{l as default};
