import{_ as n,o as a,c as e,f as t}from"./app.c2c029cd.js";const p={};function o(c,s){return a(),e("div",null,[...s[0]||(s[0]=[t(`<h1 id="可执行文件-sh-开发" tabindex="-1"><a class="header-anchor" href="#可执行文件-sh-开发" aria-hidden="true">#</a> 可执行文件 .sh 开发</h1><h2 id="创建可执行文件" tabindex="-1"><a class="header-anchor" href="#创建可执行文件" aria-hidden="true">#</a> 创建可执行文件</h2><ol><li>新建 <code>run.txt</code> 文件；</li><li>编辑内容并保存；</li><li>修改后缀名变为 <code>run.sh</code> 文件；</li><li>修改文件权限 <code>chmod 755 run.sh</code>；</li><li>双击文件执行；</li></ol><h2 id="常用语句" tabindex="-1"><a class="header-anchor" href="#常用语句" aria-hidden="true">#</a> 常用语句</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 定义脚本执行器</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,11)])])}const i=n(p,[["render",o],["__file","可执行文件 .sh 开发.html.vue"]]);export{i as default};
