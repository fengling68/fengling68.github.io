import{_ as n,o as s,c as a,f as t}from"./app.fa375d3e.js";const p={},o=t(`<h1 id="svg-实现扇形蒙层" tabindex="-1"><a class="header-anchor" href="#svg-实现扇形蒙层" aria-hidden="true">#</a> svg 实现扇形蒙层</h1><div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
