import{_ as s,o as a,c as p,f as t}from"./app.c2c029cd.js";const o={};function c(e,n){return a(),p("div",null,[...n[0]||(n[0]=[t(`<h1 id="深浅拷贝" tabindex="-1"><a class="header-anchor" href="#深浅拷贝" aria-hidden="true">#</a> 深浅拷贝</h1><h2 id="封装方法" tabindex="-1"><a class="header-anchor" href="#封装方法" aria-hidden="true">#</a> 封装方法</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">clone</span> <span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="结果展示" tabindex="-1"><a class="header-anchor" href="#结果展示" aria-hidden="true">#</a> 结果展示</h2><p><img src="https://fengling68.github.io/imgbed/images/1590412456-1078x560.webp" alt="深浅拷贝"></p>`,7)])])}const l=s(o,[["render",c],["__file","深浅拷贝.html.vue"]]);export{l as default};
