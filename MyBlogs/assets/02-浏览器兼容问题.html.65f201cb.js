import{_ as a,o as r,c as d,f as i}from"./app.a39d0481.js";const h={};function n(o,e){return r(),d("div",null,[...e[0]||(e[0]=[i(`<h1 id="浏览器兼容问题" tabindex="-1"><a class="header-anchor" href="#浏览器兼容问题" aria-hidden="true">#</a> 浏览器兼容问题</h1><h2 id="浏览器" tabindex="-1"><a class="header-anchor" href="#浏览器" aria-hidden="true">#</a> 浏览器</h2><pre><code>几种常见的浏览器：IE、Firefox、Safari、Chrome及Opera（壳浏览器）
...
</code></pre><h2 id="ie-常见的兼容问题" tabindex="-1"><a class="header-anchor" href="#ie-常见的兼容问题" aria-hidden="true">#</a> IE 常见的兼容问题</h2><h3 id="_1、文档类型的声明。" tabindex="-1"><a class="header-anchor" href="#_1、文档类型的声明。" aria-hidden="true">#</a> 1、文档类型的声明。</h3><pre><code>产生条件：IE6浏览器，当我们没有书写这个文档声明的时候，会触发IE6浏览器的怪异解析现象；
解决办法：书写文档声明。
...
</code></pre>`,87)])])}const c=a(h,[["render",n],["__file","02-浏览器兼容问题.html.vue"]]);export{c as default};
