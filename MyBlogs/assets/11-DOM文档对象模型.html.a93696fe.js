import{_ as t,o as n,c as o,f as a}from"./app.c2c029cd.js";const r={};function s(u,e){return n(),o("div",null,[...e[0]||(e[0]=[a(`<h1 id="dom文档对象模型" tabindex="-1"><a class="header-anchor" href="#dom文档对象模型" aria-hidden="true">#</a> DOM文档对象模型</h1><h2 id="dom节点" tabindex="-1"><a class="header-anchor" href="#dom节点" aria-hidden="true">#</a> DOM节点</h2><pre><code>HTML的所有内容都是节点
文档节点  元素节点  属性节点   文本节点
...
</code></pre>`,14)])])}const c=t(r,[["render",s],["__file","11-DOM文档对象模型.html.vue"]]);export{c as default};
