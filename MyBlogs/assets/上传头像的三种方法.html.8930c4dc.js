import{_ as e,o,c as a,f as n}from"./app.c2c029cd.js";const u={};function r(q,t){return o(),a("div",null,[...t[0]||(t[0]=[n(`<h1 id="上传头像的三种方法" tabindex="-1"><a class="header-anchor" href="#上传头像的三种方法" aria-hidden="true">#</a> 上传头像的三种方法</h1><h2 id="一、form表单上传文件-原生js" tabindex="-1"><a class="header-anchor" href="#一、form表单上传文件-原生js" aria-hidden="true">#</a> 一、form表单上传文件(原生JS)</h2><h3 id="_1、html部分" tabindex="-1"><a class="header-anchor" href="#_1、html部分" aria-hidden="true">#</a> 1、HTML部分</h3><pre><code>&lt;img id=&quot;img-box&quot; style=&quot;border: 1px solid gray; width: 100px; height: 100px;&quot; src=&quot;&quot;/&gt;
...
&lt;/script&gt;
</code></pre>`,16)])])}const d=e(u,[["render",r],["__file","上传头像的三种方法.html.vue"]]);export{d as default};
