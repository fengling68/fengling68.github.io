...
</code></pre></div><h2 id="vue-cli-service-element-ui-按需加载" tabindex="-1"><a class="header-anchor" href="#vue-cli-service-element-ui-按需加载" aria-hidden="true">#</a> vue-cli-service: element-ui 按需加载</h2>`,14)),a("p",null,[a("a",d,[n[0]||(n[0]=s("element-ui 官网快速入门",-1)),t(e)])]),a("p",null,[a("a",u,[n[1]||(n[1]=s("vue-cli 3.0按需引入element-ui babel.config.js配置",-1)),t(e)])]),n[5]||(n[5]=a("h2",{id:"vue-cli-service-chunk-vendors-js-文件太大",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#vue-cli-service-chunk-vendors-js-文件太大","aria-hidden":"true"},"#"),s(" vue-cli-service: chunk-vendors.js 文件太大")],-1)),a("p",null,[a("a",k,[n[2]||(n[2]=s("发布前端项目时因chunk-vendors过大导致首屏加载太慢，Vue Build时chunk-vendors的优化方案",-1)),t(e)])]),a("p",null,[a("a",m,[n[3]||(n[3]=s("提高首屏页面加载速度，解决vue-cli打包后单个文件过大的问题",-1)),t(e)])])])}const g=o(i,[["render",h],["__file","electron 开发问题.html.vue"]]);export{g as default};
