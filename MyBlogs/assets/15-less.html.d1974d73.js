import{_ as e,o as r,c as a,f as o}from"./app.c2c029cd.js";const s={};function d(t,n){return r(),a("div",null,[...n[0]||(n[0]=[o(`<h1 id="less" tabindex="-1"><a class="header-anchor" href="#less" aria-hidden="true">#</a> less</h1><h2 id="三种使用方式" tabindex="-1"><a class="header-anchor" href="#三种使用方式" aria-hidden="true">#</a> 三种使用方式</h2><pre><code>1、引入less文件，将写好的less文件，编译为CSS文件 ———— 基本不用
2、在本地进行编译, 使用 koala
...
</code></pre>`,24)])])}const i=e(s,[["render",d],["__file","15-less.html.vue"]]);export{i as default};
