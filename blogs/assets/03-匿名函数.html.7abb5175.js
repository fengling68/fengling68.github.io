import{_ as n,o as e,c as a,f as o}from"./app.50aeec2a.js";const r={},c=o(`<h1 id="匿名函数" tabindex="-1"><a class="header-anchor" href="#匿名函数" aria-hidden="true">#</a> 匿名函数</h1><h2 id="匿名函数-1" tabindex="-1"><a class="header-anchor" href="#匿名函数-1" aria-hidden="true">#</a> 匿名函数</h2><pre><code>引用数据类型(3种)：对象，数组，对象
