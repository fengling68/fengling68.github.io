import{_ as n,o as r,c as t,f as a}from"./app.a39d0481.js";const d={};function o(c,e){return r(),t("div",null,[...e[0]||(e[0]=[a(`<h1 id="css3多列、hack、优化" tabindex="-1"><a class="header-anchor" href="#css3多列、hack、优化" aria-hidden="true">#</a> CSS3多列、hack、优化</h1><h2 id="多列" tabindex="-1"><a class="header-anchor" href="#多列" aria-hidden="true">#</a> 多列</h2><pre><code>column-count:3;   &lt;!-- 元素被分隔的列数 --&gt;
...
</code></pre><blockquote><p>注意：不能使用通用选择器*{margin 0px;}</p></blockquote>`,25)])])}const s=n(d,[["render",o],["__file","11-CSS3多列、hack、优化.html.vue"]]);export{s as default};
