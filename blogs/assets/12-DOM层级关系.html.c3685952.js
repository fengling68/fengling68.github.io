import{_ as e,o as n,c as o,f as l}from"./app.bb38b1d2.js";const i={},r=l(`<h1 id="dom层级关系" tabindex="-1"><a class="header-anchor" href="#dom层级关系" aria-hidden="true">#</a> DOM层级关系</h1><h2 id="表单元素" tabindex="-1"><a class="header-anchor" href="#表单元素" aria-hidden="true">#</a> 表单元素</h2><ul><li>输入框内容，按钮内容，文本域内容，input，file</li><li>元素节点.value;</li></ul><h2 id="非表单元素" tabindex="-1"><a class="header-anchor" href="#非表单元素" aria-hidden="true">#</a> 非表单元素</h2><ul><li>innerHTML(文本+标签) innerText(设置纯文本)</li></ul><p>1、获取文本内容</p><pre><code>var myDiv = document.getElementsByTagName(&quot;div&quot;)[0];
